...
$maintainance_resize_desc = str_replace('%mw', $wggallery->getConfig('maxwidth_medium'), _AM_WGGALLERY_MAINTENANCE_RESIZE_DESC);
$maintainance_resize_desc = str_replace('%mh', $wggallery->getConfig('maxheight_medium'), $maintainance_resize_desc);
$maintainance_resize_desc = str_replace('%tw', $wggallery->getConfig('maxwidth_thumbs'), $maintainance_resize_desc);
$maintainance_resize_desc = str_replace('%th', $wggallery->getConfig('maxheight_thumbs'), $maintainance_resize_desc);
