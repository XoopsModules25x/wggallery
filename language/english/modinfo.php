...
define('_MI_WGGALLERY_EXIF_ALL', 'Show all');
define('_MI_WGGALLERY_EXIF_FILENAME', 'File name');
define('_MI_WGGALLERY_EXIF_FILEDATETIME', 'File date');
define('_MI_WGGALLERY_EXIF_FILESIZE', 'File size');
define('_MI_WGGALLERY_EXIF_MIMETYPE', 'Mimetype');
define('_MI_WGGALLERY_EXIF_CAMERA', 'Camera Type');
define('_MI_WGGALLERY_EXIF_MODEL', 'Modell');
define('_MI_WGGALLERY_EXIF_EXPTIME', 'Exposure time');
define('_MI_WGGALLERY_EXIF_FOCALLENGTH', 'Focal Length');
define('_MI_WGGALLERY_EXIF_DATETIMEORIG', 'Date time original');
