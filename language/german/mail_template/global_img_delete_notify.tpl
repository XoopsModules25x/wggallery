...
Das Bild "{IMAGE_NAME}" wurde von {X_SITENAME} gelöscht.
...
Du erhältst diese Nachricht weil Du entschieden hast, dass Du über gelöschte Bilder informiert werden möchtest.
