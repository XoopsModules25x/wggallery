...
define('_MI_WGGALLERY_EXIF_ALL', 'Alle anzeigen');
define('_MI_WGGALLERY_EXIF_FILENAME', 'Dateiname');
define('_MI_WGGALLERY_EXIF_FILEDATETIME', 'Dateidatum');
define('_MI_WGGALLERY_EXIF_FILESIZE', 'Dateigröße');
define('_MI_WGGALLERY_EXIF_MIMETYPE', 'Mime-Type');
define('_MI_WGGALLERY_EXIF_CAMERA', 'Kamera Marke');
define('_MI_WGGALLERY_EXIF_MODEL', 'Modell');
define('_MI_WGGALLERY_EXIF_EXPTIME', 'Belichtungszeit');
define('_MI_WGGALLERY_EXIF_FOCALLENGTH', 'Brennweite');
define('_MI_WGGALLERY_EXIF_DATETIMEORIG', 'Aufnahmedatum');
define('_MI_WGGALLERY_EXIF_ISO', 'ISO Speed');
