...
b("#lcl_wrap").length&&b("#lcl_wrap").remove();b("body").append('<div id="lcl_wrap" class="lcl_pre_show lcl_pre_first_el lcl_first_sizing lcl_is_resizing"><div id="lcl_window"><div id="lcl_corner_close" title="close"></div><div id="lcl_loader" class="lcl_loader_pre_first_el"><span id="lcll_1"></span><span id="lcll_2"></span></div><div id="lcl_nav_cmd"><div id="lcl_prev" class="lcl_icon lcl_prev" title="previous"></div><div id="lcl_play" class="lcl_icon lcl_play"></div><div id="lcl_next" class="lcl_icon lcl_next" title="next"></div><div id="lcl_counter" class="lcl_icon lcl_counter"></div><div id="lcl_close" class="lcl_icon lcl_right_icon lcl_close" title="close"></div><div class="lcl_icon lcl_right_icon lcl_fullscreen" title="toggle fullscreen"></div><div id="lcl_txt_toggle" class="lcl_icon lcl_right_icon lcl_txt_toggle" title="toggle text"></div><div id="lcl_download" class="lcl_icon lcl_right_icon lcl_download" title="download"></div><div id="lcl_thumbs_toggle" class="lcl_icon lcl_right_icon lcl_thumbs_toggle" title="toggle thumbnails"></div><div id="lcl_socials" class="lcl_icon lcl_right_icon lcl_socials" title="toggle socials"></div></div><div id="lcl_contents_wrap"><div id="lcl_subj"><div id="lcl_elem_wrap"></div></div><div id="lcl_txt"></div></div></div><div id="lcl_thumbs_nav"></div><div id="lcl_overlay"></div></div>');
...
h.elem_index;b("#lcl_elem_wrap").removeAttr("style").removeAttr("class").empty();b("#lcl_wrap").attr("lcl-type",d.type);b("#lcl_elem_wrap").addClass("lcl_"+d.type+"_elem");switch(d.type){case "image":b("#lcl_elem_wrap").css("background-image","url('"+d.src+"')");break;default:b("#lcl_elem_wrap").html('<div id="lcl_inline" class="lcl_elem"><br/>Error loading the resource .. </div>')}if(lcl_curr_opts.download)if(d.download){b(".lcl_download").show();var f=d.download.split("/");f=f[f.length-1];b(".lcl_download").html('<a id="lcl_downloadlink" href="'+
