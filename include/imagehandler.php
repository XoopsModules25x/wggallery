...
function ResizeAndCrop($src_url, $src_mimetype, $dest_url, $dest_w, $dest_h, $quality=90)
{
    ...
    if (!imagecopyresampled($thumb, $original, 0,0,0,0, $dest_w_resize, $dest_h_resize, $original_w, $original_h)) return FALSE;
    ...
    if (!imagecopy($final, $thumb, 0,0, $dest_w_offset, $dest_h_offset, $dest_w_resize, $dest_h_resize)) return FALSE;

    // STORE THE FINAL IMAGE - WILL OVERWRITE $dest_url
    if (!imagejpeg($final, $dest_url, $quality)) return FALSE;
    return TRUE;
}
