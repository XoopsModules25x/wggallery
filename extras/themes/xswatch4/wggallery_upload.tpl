...
<div class='multiupload-footer'>
	<{if $albId|default:false}>
		<div class='col-xs-12 col-sm-12 right'>
			<a class='btn btn-secondary wgg-btn' href='images.php?op=list&amp;ref=albums&amp;alb_id=<{$albId|default:0}>&amp;alb_pid=<{$albPid|default:0}><{if $subm_id|default:false}>&amp;subm_id=<{$subm_id}><{/if}>' title='<{$smarty.const._CO_WGGALLERY_IMAGES_INDEX}>'>
            ...
            <a class='btn btn-secondary wgg-btn' href='albums.php?op=edit&amp;alb_id=<{$albId|default:0}>' title='<{$smarty.const._CO_WGGALLERY_ALBUM_EDIT}>'>
			...
			<a class='btn btn-secondary wgg-btn' href='album_images.php?op=list&amp;alb_id=<{$albId|default:0}>' title='<{$smarty.const._CO_WGGALLERY_ALBUM_IH_IMAGE_EDIT}>'>
