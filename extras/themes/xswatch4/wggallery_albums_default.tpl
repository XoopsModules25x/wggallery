		...
		<div class='panel-body'>
			<{foreach item=album from=$albums_list}>
				<div class='row wgg-album-list'>
					<div class='col-sm-4'>
						<img id='album_<{$album.id}>' class='img-fluid wgg-album-img' src='<{$album.image}>?<{$force|default:''}>' alt='<{$smarty.const._CO_WGGALLERY_ALBUM_IMAGE}> <{$album.name}>'>
					</div>
					<div class='col-sm-4'>
						<p class='wgg-album-name'><{$album.name}></p>
						<p class='wgg-album-desc'><{$album.desc|default:''}></p>
					</div>
					<div class='col-sm-4'>
						<p><img class='wgg-btn-icon' src='<{$wggallery_icon_url_16}>collection.png'
							alt='<{if $album.iscoll|default:0 == 1}><{$smarty.const._CO_WGGALLERY_ALBUM_COLL}><{else}><{$smarty.const._CO_WGGALLERY_ALBUM}><{/if}>'>
							<{if $album.iscoll|default:0 == 1}><{$smarty.const._CO_WGGALLERY_ALBUM_COLL}><{else}><{$smarty.const._CO_WGGALLERY_ALBUM}><{/if}>
						</p>
						...
						<{if $album.nb_subalbums|default:0 > 1}>
					...
					<div class='col-sm-12 center'>
						<{if $album.nb_images|default:0 > 0}>
							<{if $gallery|default:false}>
								<a class='btn btn-secondary wgg-btn' href='<{$wggallery_url}>/gallery.php?op=show&amp;alb_id=<{$album.id}>&amp;alb_pid=<{$album.pid}><{if $subm_id|default:false}>&amp;subm_id=<{$subm_id}><{/if}>' title='<{$smarty.const._CO_WGGALLERY_IMAGES_ALBUMSHOW}>' target='<{$gallery_target}>' >
									...
									<{if $displayButtonText|default:false}><{$smarty.const._CO_WGGALLERY_IMAGES_ALBUMSHOW}><{/if}>
								</a>
							<{/if}>
							<a class='btn btn-secondary wgg-btn' href='<{$wggallery_url}>/images.php?op=list&amp;ref=albums&amp;alb_id=<{$album.id}>&amp;alb_pid=<{$album.pid}><{if $subm_id|default:false}>&amp;subm_id=<{$subm_id}><{/if}>' title='<{$smarty.const._CO_WGGALLERY_IMAGES_INDEX}>'>
								...
								<{if $displayButtonText|default:false}><{$smarty.const._CO_WGGALLERY_IMAGES_INDEX}><{/if}>
							</a>
						<{else}>
						...
						<{if $album.edit|default:false}>
                            ...
                            <{/if}>
							<{if $album.iscoll|default:false == 0}>
                            ...
                            <a class='btn btn-secondary wgg-btn' href='album_images.php?op=imghandler&amp;alb_id=<{$album.id}>&amp;alb_pid=<{$album.pid}>' title='<{$smarty.const._CO_WGGALLERY_ALBUM_IH_IMAGE_EDIT}>'>
                                <img class='wgg-btn-icon' src='<{$wggallery_icon_url_16}>album_images.png' alt='<{$smarty.const._CO_WGGALLERY_ALBUM_IH_IMAGE_EDIT}>'><{if $displayButtonText|default:false}><{$smarty.const._CO_WGGALLERY_ALBUM_IH_IMAGE_EDIT}><{/if}></a>
                        ...
                        <{/if}>
                        <{if $album.iscoll|default:false == 0 && $album.download|default:false && $album.nb_images|default:0 > 0}>
						...
						<{if $album.nb_subalbums|default:0 > 0}>
							<a class='btn btn-secondary wgg-btn' href='albums.php?op=list&amp;alb_pid=<{$album.id}><{if $subm_id|default:false}>&amp;subm_id=<{$subm_id}><{/if}>' title='<{$smarty.const._CO_WGGALLERY_COLL_ALBUMS}>'>
								<img class='wgg-btn-icon' src='<{$wggallery_icon_url_16}>index.png' alt='<{$smarty.const._CO_WGGALLERY_COLL_ALBUMS}>'><{if $displayButtonText|default:false}><{$smarty.const._CO_WGGALLERY_COLL_ALBUMS}><{/if}></a>
						<{/if}>
					</div>
				</div>
			<{/foreach}>
			...
			<div class='panel-body'>
				...
				<p class='center'>
					<a class='btn btn-secondary wgg-btn' href='albums.php' title='<{$smarty.const._CO_WGGALLERY_UPDATE}>'>
						<img class='wgg-btn-icon' src='<{$wggallery_icon_url_16}>reset.png' alt='<{$smarty.const._CO_WGGALLERY_UPDATE}>'><{if $displayButtonText|default:false}><{$smarty.const._CO_WGGALLERY_UPDATE}><{/if}></a>
					<{if $global_submit|default:false}>
						<a class='btn btn-secondary wgg-btn' href='albums.php?op=new&alb_pid=<{$albPid|default:0}>' title='<{$smarty.const._CO_WGGALLERY_ALBUM_ADD}>'>
							<img class='wgg-btn-icon' src='<{$wggallery_icon_url_16}>add.png' alt='<{$smarty.const._CO_WGGALLERY_ALBUM_ADD}>'><{if $displayButtonText|default:false}><{$smarty.const._CO_WGGALLERY_ALBUM_ADD}><{/if}></a>
					<{/if}>
				</p>
			</div>
		</div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <{foreach item=image from=$images|default:null}>
                        <{if $image.alb_name|default:false}><h4 class="modal-title"><{$image.alb_name}></h4><{/if}>
