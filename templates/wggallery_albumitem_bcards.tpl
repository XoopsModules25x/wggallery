	...
	<div class="card">
		...
		<div class="card-body">
            ...
            <p class="center">
                ...
                <{else}>
                    <a class='btn btn-primary' href='<{$wggallery_url}>/images.php?op=list&amp;alb_id=<{$album.id}>&amp;alb_pid=<{$alb_pid}>' title='<{$smarty.const._CO_WGGALLERY_IMAGES_INDEX}>'><{$smarty.const._CO_WGGALLERY_IMAGES_INDEX}>
                <{/if}>
                </a>
            </p>
        </div>
