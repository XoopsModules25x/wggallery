		...
		<{foreach item=image from=$images}>
			<div class='row wgg-img-panel wgg-image-list'>
				...
				<div class='wgg-img-panel-row col-sm-4'>
					...
					<p><img class='wgg-btn-icon' src='<{$wggallery_icon_url_16}>/state<{$image.state}>.png' alt='<{$smarty.const._AM_WGGALLERY_IMAGE_STATE}>' title='<{$smarty.const._AM_WGGALLERY_IMAGE_STATE}>' /><{$image.state_text}></p>
