...
<div class='center wgg-album-footer'>
    <a class='btn btn-default wgg-btn' href='index.php?op=list&amp;alb_pid=<{$category.id}><{if $subm_id|default:''}>&amp;subm_id=<{$subm_id}><{/if}>' title='<{$smarty.const._CO_WGGALLERY_COLL_ALBUMS}>'>
